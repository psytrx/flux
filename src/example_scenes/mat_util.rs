use crate::flux::{
    materials::{Material, MatteMaterial},
...
pub fn diffuse(r: f32, g: f32, b: f32) -> std::rc::Rc<dyn Material> {
    std::rc::Rc::new(crate::flux::materials::DiffuseLightMaterial::new(Box::new(
        ConstantTexture::new(glam::vec3(r, g, b)),
    )))
}
